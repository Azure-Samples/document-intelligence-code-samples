...
>- on July 2023, the Azure Cognitive Services Form Recognizer service was renamed to Azure AI Document Intelligence. Any mentions of Form Recognizer or Document Intelligence in documentation refer to the same Azure service.
>- The contents of this folder apply to the latest version: **v4.0** . 
You can click  **[v3.1 (GA)](../../v3.1(GA)/.NET(v3.1))**  to view earlier versions.
...
[Source code](src) | [Package (NuGet)][docint_nuget_package] | [API reference documentation][docint_refdocs] | [Product documentation][docint_docs] | [Samples](samples)
...
[extract_layout]: samples/Sample_ExtractLayout.md
[analyze_prebuilt]: samples/Sample_AnalyzeWithPrebuiltModel.md
[build_a_custom_model]: samples/Sample_BuildCustomModel.md
[build_a_document_classifier]: samples/Sample_BuildDocumentClassifier.md
[classify_document]: samples/Sample_ClassifyDocument.md
[manage_models]: samples/Sample_ManageModels.md
[copy_custom_models]: samples/Sample_CopyCustomModel.md
[compose_model]: samples/Sample_ModelCompose.md
[get_and_list]: samples/Sample_GetAndListOperations.md
[analyze_with_addons]: samples/Sample_AddOnCapabilities.md
[extract_layout_markdown]: samples/Sample_ExtractLayoutAsMarkdown.md
