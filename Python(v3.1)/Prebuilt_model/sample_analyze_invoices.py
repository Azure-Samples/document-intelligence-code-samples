...
DESCRIPTION:
    ...
    https://aka.ms/V3.1-invoice-field-schema
...
def analyze_invoice():
    ...
    url = "https://github.com/Azure-Samples/cognitive-services-REST-api-samples/raw/master/curl/form-recognizer/rest-api/invoice.pdf"
    ...
    poller = document_analysis_client.begin_analyze_document_from_url(
        "prebuilt-invoice", document_url=url, locale="en-US"
    )
...
# Next steps:
# Learn more about Invoice model: https://aka.ms/V3.1-concept-invoice
