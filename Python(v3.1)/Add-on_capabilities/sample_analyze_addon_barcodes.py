...
def analyze_barcodes():
    ...
    #         "prebuilt-layout", document=f, features=[AnalysisFeature.BARCODES]    # Specify which add-on capabilities to enable.
    #     )
...
# Next steps:
# Learn more about Add-on capabilities (Barcode property extraction): https://aka.ms/V3.1-barcode-property-extraction
