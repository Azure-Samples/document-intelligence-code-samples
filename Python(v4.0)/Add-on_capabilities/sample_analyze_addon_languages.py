...
PREREQUISITES:
    ...
    2) Open the "sample_analyze_addon_languages.py" file and insert the provided code sample into your application.
...
# Next steps:
# Learn more about Add-on capabilities (Language detection): https://aka.ms/language-detection
